...
ui <- shinyUI(fluidPage(
  ...
  navlistPanel(
    ...
    tabPanel("Pie Chart: Perfused VS Malperfused",
             ...
             h4("To hide perfused region click on the perfused label in legend."),
...
","Malperfusion - Dark on post")
    ...
    malperfusedTissue <- data.table(Segment=c('Perfused','Tissue 2','Malperfused Bone','Epiphyseal Cartilage Overlapped with Malperfusion','Physeal Cartilage Overlapped with Malperfusion'), Volume=c(perfused, segment2$VolumePerthes))
    malperfusedTissue = malperfusedTissue[order(factor(malperfusedTissue$Segment,levels=c('Perfused','Tissue 2','Malperfused Bone','Epiphyseal Cartilage Overlapped with Malperfusion','Physeal Cartilage Overlapped with Malperfusion')))]
    ...
    pie2 <- plot_ly(malperfusedTissue,labels=~fct_inorder(malperfusedTissue$Segment),values=~malperfusedTissue$Volume,
                    ...
                    marker = list(colors = c("#FFFFFF","#cab2d6","#B88101","#14527B","#758F9F"),
